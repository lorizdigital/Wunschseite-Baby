  ...
  async function importProductDetails() {
    ...
    try {
      ...
      setNewWish((current) => current.productUrl.trim() !== requestedUrl ? current : {
        ...
        currency: data.draft.currency?.toUpperCase() ?? "EUR",
