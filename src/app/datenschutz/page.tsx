  ...
  return (
    <main className="legal-page">
      ...
      <section>
        ...
        <p>Die Authentifizierungs-E-Mail enthält den Magic Link und die für dessen Zustellung notwendigen Versanddaten. Sie dient ausschließlich Anmeldung, Registrierung oder sicherheitsbezogenen Kontofunktionen; Newsletter, Werbung und Profiling per E-Mail finden nicht statt. Für die Zustellung verwenden wir vorrangig Brevo. Ist dieser Versandweg nicht konfiguriert oder vorübergehend nicht verfügbar, versendet Supabase die Authentifizierungs-E-Mail als technischen Rückfallweg. Der jeweilige Versanddienst erhält dafür die E-Mail-Adresse, den Inhalt der Transaktions-E-Mail einschließlich des zeitlich begrenzten Anmeldelinks sowie technische Zustell- und Fehlerdaten.</p>
      ...
      <section>
        ...
        <p>Zum Schutz gegen Missbrauch begrenzen wir insbesondere Anmelde-, Einladungs-, Reservierungs-, Produktimport- und externe Bildanfragen. Hierfür wird die aus der Anfrage ermittelte IP-Adresse beziehungsweise eine technische Benutzer- oder Listenzuordnung nicht als Klartextwert im Rate-Limit-Schlüssel abgelegt, sondern zusammen mit dem jeweiligen Zweck gehasht und zur Zählung von Anfragen verwendet. Außerdem werden technische Einmal-Schlüssel genutzt, damit eine Reservierungsanfrage nicht versehentlich mehrfach ausgeführt wird. Cloudflare verarbeitet IP- und Requestdaten zusätzlich im Rahmen der Hosting- und Sicherheitsinfrastruktur.</p>
      ...
      <section>
        ...
        <p>Empfänger personenbezogener Daten sind nur diejenigen Stellen, die sie zur Erbringung und Absicherung des Dienstes benötigen: Cloudflare für Hosting und Sicherheitsinfrastruktur, Supabase für Authentifizierung einschließlich des technischen Auth-E-Mail-Rückfallwegs, Datenbank und Dateispeicher sowie Brevo für den vorrangigen transaktionalen Versand von Authentifizierungs- und Einladungs-E-Mails. Bei einer von Ihnen veranlassten Produktabfrage oder beim Aufruf externer Produktlinks treten zusätzlich die jeweils ausgewählten Händler beziehungsweise Bildanbieter als eigenständig Verantwortliche hinzu.</p>
