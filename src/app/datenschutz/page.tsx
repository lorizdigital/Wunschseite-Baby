  ...
  return (
    <main className="legal-page">
      ...
      <section>
        ...
        <p>Die Anwendung verschickt aus der Einladungsfunktion derzeit keine eigene Einladung per E-Mail. Die gespeicherte E-Mail-Adresse dient der Zuordnung der Einladung, wenn die eingeladene Person sich mit dieser Adresse anmeldet. Falls später ein automatischer Einladungsversand ergänzt wird, werden Versanddienst, Datenkategorien und Speicherdauer vor dessen Aktivierung hier konkret benannt.</p>
      </section>
      ...
      <section>
        ...
        <p>Empfänger personenbezogener Daten sind nur diejenigen Stellen, die sie zur Erbringung und Absicherung des Dienstes benötigen: Cloudflare für Hosting und Sicherheitsinfrastruktur, Supabase für Authentifizierung, Datenbank und Dateispeicher sowie gegebenenfalls der in Supabase konfigurierte Transaktions-E-Mail-Dienst. Bei einer von Ihnen veranlassten Produktabfrage oder beim Aufruf externer Produktlinks treten zusätzlich die jeweils ausgewählten Händler beziehungsweise Bildanbieter als eigenständig Verantwortliche hinzu.</p>
        <p>Mit Cloudflare und Supabase werden Auftragsverarbeitungsvereinbarungen eingesetzt. Soweit ein Empfänger Daten außerhalb des EWR verarbeitet, erfolgt dies nur unter den Voraussetzungen der Art. 44 ff. DSGVO, insbesondere auf Grundlage eines Angemessenheitsbeschlusses oder der EU-Standardvertragsklauseln mit ergänzenden Schutzmaßnahmen. Wir verkaufen keine personenbezogenen Daten und setzen keine Datenbroker ein.</p>
      </section>
