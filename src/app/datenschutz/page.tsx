  ...
  return (
    <main className="legal-page">
      ...
      <section>
        ...
        <p>Empfänger personenbezogener Daten sind nur diejenigen Stellen, die sie zur Erbringung und Absicherung des Dienstes benötigen: Cloudflare für Hosting und Sicherheitsinfrastruktur sowie Supabase für Authentifizierung einschließlich Auth-E-Mail-Versand, Datenbank und Dateispeicher. Bei einer von Ihnen veranlassten Produktabfrage oder beim Aufruf externer Produktlinks treten zusätzlich die jeweils ausgewählten Händler beziehungsweise Bildanbieter als eigenständig Verantwortliche hinzu.</p>
