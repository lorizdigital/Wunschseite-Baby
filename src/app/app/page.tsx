...
export default async function AppHomePage({ searchParams }: { searchParams: Promise<{ deleted?: string }> }) {
  ...
  return <main className="admin-page"><div className="admin-wrap app-wrap">
    <header className="admin-head"><p className="eyebrow">Elternbereich</p><h1>Deine Wunschlisten</h1><p>Du bist als {auth.user.email ?? "eingeladene Person"} angemeldet.</p></header>
